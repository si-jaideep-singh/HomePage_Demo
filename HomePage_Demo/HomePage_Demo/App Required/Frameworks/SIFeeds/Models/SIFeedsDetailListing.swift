...
public struct SIFeedsDetailDataClass: Codable {
   ...
   // public let highlights: [String]?
    ...
    public let createdByName, imagedata, focusByKeywords, parentArticleID: String?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.focusByKeywords = try container.decodeIfPresent(String.self, forKey: .focusByKeywords)
